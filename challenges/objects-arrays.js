...
console.log(aniNames(zooAnimals));
...
*/
function namesLowerCase(zooAnimals){
  ...
  console.log(namesLowerCase(zooAnimals));
...
*/
function lowPopulation(zooAnimals){
...
*/
function animalPopulation(zooAnimals){ 
